                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select name="category"
                                ...
                                <option value="layers"
                                    {{ old('category', $livestock->category) == 'layers' ? 'selected' : '' }}>
                                    Layers
                                </option>

                                <option value="broilers"
                                    {{ old('category', $livestock->category) == 'broilers' ? 'selected' : '' }}>
                                    Broilers
                                </option>
                        ...
                        <div>
                            ...
                            <input type="date" name="start_date"
                                   value="{{ old('start_date', $livestock->start_date->format('Y-m-d')) }}"
                                   class="mt-1 w-full border-gray-300 rounded-lg shadow-sm">
                        </div>
